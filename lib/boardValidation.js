...
BoardValidation.prototype.evaluateCastle = function (side, validMoves) {
	'use strict';
	...
	var
		...
		r = null,
		rank = side === piece.SideType.White ? 1 : 8,
		squares = {
...
BoardValidation.prototype.start = function (side, callback) {
	'use strict';
	...
	if (this.board) {
		...
		squares = this.board.getSquares(side);
		...
		this.evaluateCastle(side, validMoves);
